    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Votre mot de passe a été mis à jour."
                : message == ManageMessageId.SetPasswordSuccess ? "Vous avez defini le mot de passe."
                : message == ManageMessageId.SetTwoFactorSuccess ? "L'authentification 2-tiers a été defini."
                : message == ManageMessageId.Error ? "Une erreur est survénue."
                : message == ManageMessageId.AddPhoneSuccess ? "Votre numero de téléphone a été ajouté."
                : message == ManageMessageId.RemovePhoneSuccess ? "Votre numero de téléphone a été supprimé."
                : "";
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError("", "Echec de verification du numero de téléphone.");
            return View(model);
        }
        ...
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "L'authenfication externe a été annulée."
